...
//             add image
            Image logo;
			try {
				logo = Image.getInstance(HeaderFooterPageEvent.class.getResource("/memorynotfound-logo.jpg"));
				header.addCell(logo);
			} catch (IOException e) {
    ...
    private void addFooter(PdfWriter writer){
        ...
        try {
            ...
            // add copyright
            footer.addCell(new Phrase("\u00A9thewavespgrooms.com", new Font(Font.FontFamily.HELVETICA, 12, Font.NORMAL)));
